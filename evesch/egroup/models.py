...
class UserGroupManager(models.Manager):
    ...
    def init_org_groups(self, org, user):
        ...
        admin_group = UserGroup(
            group_name="Administrator Group",
        ...
        event_coordinator_group = UserGroup(
            group_name="Event Coordinator Group",
    ...
    def get_current_usergroup(self, group_hash, message=None):
        if message:
            ...
            try:
                ...
                message = Message(
                    title=_("User Group Not Found"),
                    text=_("The user group was not found"))
...
class UserGroup(models.Model):
    ...
    org_name = models.ForeignKey(
        Organization, related_name='group_set', on_delete=models.CASCADE)
