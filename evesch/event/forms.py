...
class EventTypeForm(forms.ModelForm):
    ...
    type_color = ColorField(
        widget=forms.TextInput(attrs={'size': '6', 'class': 'color',}), max_length=6)
    class Meta:
        model = EventType
...
class EventForm(forms.ModelForm):
    ...
    event_date = forms.DateTimeField(
        widget=forms.DateTimeInput(
            attrs={'id': 'id_event_date',}, format="%m/%d/%Y %H:%M"))
    event_signup_deadline = forms.DateTimeField(
        required=False, 
        widget=forms.DateTimeInput(
            attrs={'id': 'id_event_signup_deadline',}, format="%m/%d/%Y %H:%M"))    
...
class AttendeeForm(forms.ModelForm):
    ...
    def __init__(self, current_event, *args, **kwargs):
        ...
        if current_event.event_track_hours:
            self.fields['att_hours'] = HourField(
                widget=forms.TextInput(attrs={'size': '5',}), max_length=5)
        if current_event.att_header_col1:
            if current_event.att_type_col1 == 1:
                self.fields['att_col1'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col1,
                    required=current_event.att_require_col1)  
            elif current_event.att_type_col1 == 2:
                self.fields['att_col1'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col1)),
                    label=current_event.att_header_col1,
                    required=current_event.att_require_col1)
            elif current_event.att_type_col1 == 3:
                self.fields['att_col1'] = forms.IntegerField(
        ...
        if current_event.att_header_col2:
            if current_event.att_type_col2 == 1:
                self.fields['att_col2'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col2,
                    required=current_event.att_require_col2)  
            elif current_event.att_type_col2 == 2:
                self.fields['att_col2'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col2)),
                    label=current_event.att_header_col2,
                    required=current_event.att_require_col2)
            elif current_event.att_type_col2 == 3:
                self.fields['att_col2'] = forms.IntegerField(
                    widget=forms.TextInput(attrs={'size': '15'}),
                    label=current_event.att_header_col2,
                    required=current_event.att_require_col2)
            else:
        ...
        if current_event.att_header_col3:
            if current_event.att_type_col3 == 1:
                self.fields['att_col3'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col3,
                    required=current_event.att_require_col3)  
            elif current_event.att_type_col3 == 2:
                self.fields['att_col3'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col3)),
                    label=current_event.att_header_col3,
                    required=current_event.att_require_col3)
            elif current_event.att_type_col3 == 3:
                self.fields['att_col3'] = forms.IntegerField(
                    widget=forms.TextInput(attrs={'size': '15'}),
                    label=current_event.att_header_col3,
                    required=current_event.att_require_col3)
            else:
        ...
        if current_event.att_header_col4:
            if current_event.att_type_col4 == 1:
                self.fields['att_col4'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col4,
                    required=current_event.att_require_col4)  
            elif current_event.att_type_col4 == 2:
                self.fields['att_col4'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col4)),
                    label=current_event.att_header_col4,
                    required=current_event.att_require_col4)
            elif current_event.att_type_col4 == 3:
                self.fields['att_col4'] = forms.IntegerField(
                    widget=forms.TextInput(attrs={'size': '15'}),
                    label=current_event.att_header_col4,
                    required=current_event.att_require_col4)
            else:
        ...
        if current_event.att_header_col5:
            if current_event.att_type_col5 == 1:
                self.fields['att_col5'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col5,
                    required=current_event.att_require_col5)  
            elif current_event.att_type_col5 == 2:
                self.fields['att_col5'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col5)),
                    label=current_event.att_header_col5,
                    required=current_event.att_require_col5)
            elif current_event.att_type_col5 == 3:
                self.fields['att_col5'] = forms.IntegerField(
                    widget=forms.TextInput(attrs={'size': '15'}),
                    label=current_event.att_header_col5,
                    required=current_event.att_require_col5)
            else:
        ...
        if current_event.att_header_col6:
            if current_event.att_type_col6 == 1:
                self.fields['att_col6'] = forms.BooleanField(
                    widget=forms.CheckboxInput(),
                    label=current_event.att_header_col6,
                    required=current_event.att_require_col6)  
            elif current_event.att_type_col6 == 2:
                self.fields['att_col6'] = forms.CharField(
                    widget=forms.Select(choices = self.parse_csv(
                        current_event.att_type_drop_col6)),
                    label=current_event.att_header_col6,
                    required=current_event.att_require_col6)
            elif current_event.att_type_col6 == 3:
                self.fields['att_col6'] = forms.IntegerField(
                    widget=forms.TextInput(attrs={'size': '15'}),
                    label=current_event.att_header_col6,
                    required=current_event.att_require_col6)
            else:
